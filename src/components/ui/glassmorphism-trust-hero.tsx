      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 pt-24 pb-12 sm:px-6 md:pt-32 md:pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            {/* Heading */}
            <h1 
              className="animate-fade-in delay-200 font-syne text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-medium tracking-tighter leading-[0.9]"
              style={{
            ...
            >
              Crafting Digital<br />
              <span className="bg-gradient-to-br from-white via-white to-cyan-400 bg-clip-text text-transparent">
                Experiences
              </span><br />
              That Matter
            </h1>
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Diseñamos ecosistemas hiper-convertidores que combinan arquitectura industrial con funcionalidad extrema,
              creando experiencias Living Web para el sector B2B.
            </p>

            {/* CTA Buttons */}
            <div className="animate-fade-in delay-400 flex flex-col sm:flex-row gap-4">
              <button className="group inline-flex items-center justify-center gap-2 rounded-full bg-cyan-400 px-8 py-4 text-sm font-bold text-zinc-950 transition-all hover:scale-[1.02] hover:bg-cyan-300 active:scale-[0.98]">
                View Portfolio
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <div className="text-3xl font-bold font-syne tracking-tight text-white">150+</div>
                    <div className="text-sm font-medium text-zinc-400">Proyectos B2B</div>
                  </div>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  <div className="flex justify-between text-sm">
                    <span className="text-zinc-400">Satisfacción B2B</span>
                    <span className="text-white font-medium">99%</span>
                  </div>
                  <div className="h-2 w-full overflow-hidden rounded-full bg-zinc-800/50">
                    <div className="h-full w-[99%] rounded-full bg-gradient-to-r from-cyan-600 to-cyan-300" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  <StatItem value="10+" label="Partners" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="24/7" label="Soporte IA" />
                  <div className="w-px h-full bg-white/10 mx-auto" />
                  <StatItem value="100%" label="Escalable" />
                </div>

                {/* Tag Pills */}
                <div className="mt-8 flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-1.5 rounded-full border border-cyan-500/10 bg-cyan-500/5 px-3 py-1 text-[10px] font-medium tracking-wide text-cyan-300">
            ...
            <div className="animate-fade-in delay-500 relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 py-8 backdrop-blur-xl">
              <h3 className="mb-6 px-8 text-sm font-medium text-zinc-400">Adoptado por Gigantes Industriales</h3>
                ...
                <div className="animate-marquee flex gap-12 whitespace-nowrap px-4 w-max">
                  ...
                  {[...CLIENTS, ...CLIENTS, ...CLIENTS].map((client, i) => (
                    ...
                    >
                      ...
                      {/* Brand Name */}
                      <span className="text-lg font-syne font-bold text-white tracking-tight">
                        {client.name}
                      </span>
                    </div>
                  ))}
