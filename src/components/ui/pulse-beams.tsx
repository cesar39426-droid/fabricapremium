...
const SVGs = ({ beams, width, height, baseColor, accentColor, gradientColors }: SVGsProps) => {
  return (
    ...
    >
      ...
      <defs>
        {beams.map((beam, index) => {
           // We cast to any for Framer Motion's SVG elements because TS doesn't perfectly type animate arrays
           const MotionLinearGradient = motion.linearGradient as any;
           return (
